  ...
  try {
    ...
    if (generatedContent) {
      ...
      */
      ...
      console.log("Image Response:", imageResponse); //return Image Response: [
        //'https://replicate.delivery/yhqm/XWcj5JXKBjJ5BhBgFnL89zVCsh6xlvv7bbjY1iZ9wlfOnqiJA/out-0.png'
      //]
      //console.log("Image Response:", imageResponse['data']); //return  undefined
